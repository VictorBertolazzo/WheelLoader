...
#ifndef DWL2015_DRIVELINE_2WD_H
#define DWL2015_DRIVELINE_2WD_H
...
class CH_MODELS_API DWL2015_Driveline2WD : public ChShaftsDriveline2WD {
  public:
    DWL2015_Driveline2WD(const std::string& name);

    ~DWL2015_Driveline2WD() {}
