...
#ifndef DWL2015_REISSNER_TIRE_H
#define DWL2015_REISSNER_TIRE_H
...
class CH_MODELS_API DWL2015_ReissnerTire : public ChReissnerTire {
  public:
    DWL2015_ReissnerTire(const std::string& name);
    ~DWL2015_ReissnerTire() {}
