...
// =============================================================================
//
// DWL2015 Fiala tire subsystem
//
// =============================================================================

#ifndef DWL2015_FIALA_TIRE_H
#define DWL2015_FIALA_TIRE_H
...
class CH_MODELS_API DWL2015_FialaTire : public ChFialaTire {
  public:
    DWL2015_FialaTire(const std::string& name);
    ~DWL2015_FialaTire() {}
