...
#ifndef DWL20159_DOUBLEWISHBONE_REDUCED_H
#define DWL20159_DOUBLEWISHBONE_REDUCED_H
...
class CH_MODELS_API DWL2015_DoubleWishboneReducedFront : public ChDoubleWishboneReduced {
  public:
    DWL2015_DoubleWishboneReducedFront(const std::string& name);
    ~DWL2015_DoubleWishboneReducedFront();
...
class DWL2015_DoubleWishboneReducedRear : public chrono::vehicle::ChDoubleWishboneReduced {
  public:
    DWL2015_DoubleWishboneReducedRear(const std::string& name);
    ~DWL2015_DoubleWishboneReducedRear();
