...
#ifndef DWL2015_CHASSIS_H
#define DWL2015_CHASSIS_H
...
/// DWL2015 chassis subsystem.
class CH_MODELS_API DWL2015_Chassis : public ChChassis {
  public:
    DWL2015_Chassis(const std::string& name, bool fixed = false);
    ~DWL2015_Chassis() {}
