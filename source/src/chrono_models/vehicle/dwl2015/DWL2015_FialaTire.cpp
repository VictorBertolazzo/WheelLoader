...
const double DWL2015_FialaTire::m_normalDamping = 17513;

const std::string DWL2015_FialaTire::m_meshName = "hmmwv_tire_POV_geom";
const std::string DWL2015_FialaTire::m_meshFile = "hmmwv/hmmwv_tire.obj";

// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
DWL2015_FialaTire::DWL2015_FialaTire(const std::string& name) : ChFialaTire(name) {
}

// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
void DWL2015_FialaTire::SetFialaParams() {
...
double DWL2015_FialaTire::GetNormalStiffnessForce(double depth) const {
...
void DWL2015_FialaTire::AddVisualizationAssets(VisualizationType vis) {
...
void DWL2015_FialaTire::RemoveVisualizationAssets() {
	ChFialaTire::RemoveVisualizationAssets();

	// Make sure we only remove the assets added by DWL2015_FialaTire::AddVisualizationAssets.
