...
#ifndef DWL2015_DRIVELINE_4WD_H
#define DWL2015_DRIVELINE_4WD_H
...
class CH_MODELS_API DWL2015_Driveline4WD : public ChShaftsDriveline4WD {
  public:
    DWL2015_Driveline4WD(const std::string& name);
    ~DWL2015_Driveline4WD() {}
