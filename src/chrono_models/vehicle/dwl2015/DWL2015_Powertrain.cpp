...
// =============================================================================
//
// DWL2015 powertrain model based on ChShaft objects.
//
// =============================================================================
...
// Static variables
// -----------------------------------------------------------------------------
const double DWL2015_Powertrain::m_motorblock_inertia = 10.5;
const double DWL2015_Powertrain::m_crankshaft_inertia = 1.1;
const double DWL2015_Powertrain::m_ingear_shaft_inertia = 0.3;
...
// -----------------------------------------------------------------------------
DWL2015_Powertrain::DWL2015_Powertrain() : ChShaftsPowertrain(ChVector<>(1, 0, 0)) {}

// -----------------------------------------------------------------------------
// Initialize vector of gear ratios
// -----------------------------------------------------------------------------
void DWL2015_Powertrain::SetGearRatios(std::vector<double>& gear_ratios) {
...
//
// -----------------------------------------------------------------------------
void DWL2015_Powertrain::SetEngineTorqueMap(std::shared_ptr<ChFunction_Recorder>& map) {
...
void DWL2015_Powertrain::SetEngineLossesMap(std::shared_ptr<ChFunction_Recorder>& map) {
    double rpm_to_radsec = CH_C_2PI / 60.;
...
void DWL2015_Powertrain::SetTorqueConverterCapacityFactorMap(std::shared_ptr<ChFunction_Recorder>& map) {
    map->AddPoint(0.0, 15);
...
void DWL2015_Powertrain::SetTorqeConverterTorqueRatioMap(std::shared_ptr<ChFunction_Recorder>& map) {
