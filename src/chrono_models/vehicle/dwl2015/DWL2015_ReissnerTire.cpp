...
// =============================================================================
//
// DWL2015 Reissner-shell tire subsystem
//
// =============================================================================
...
// Static variables
// -----------------------------------------------------------------------------
const double DWL2015_ReissnerTire::m_tire_radius = 0.4673;
const double DWL2015_ReissnerTire::m_rim_radius = 0.2683;
const double DWL2015_ReissnerTire::m_rim_width = 0.254;

const double DWL2015_ReissnerTire::m_alpha = 0.005;
const double DWL2015_ReissnerTire::m_default_pressure = 200e3;

const double DWL2015_ReissnerTire::m_rho_0 = 0.1e4;
const ChVector<> DWL2015_ReissnerTire::m_E_0(0.756e10, 0.474e8, 0.474e8);
const double DWL2015_ReissnerTire::m_nu_0 = 0.45;
const ChVector<> DWL2015_ReissnerTire::m_G_0(0.1634e8, 0.1634e8, 0.1634e8);
const double DWL2015_ReissnerTire::m_rho_1 = 0.2639e4;
const ChVector<> DWL2015_ReissnerTire::m_E_1(0.18e12, 0.474e8, 0.474e8);
const double DWL2015_ReissnerTire::m_nu_1 = 0.45;
const ChVector<> DWL2015_ReissnerTire::m_G_1(0.1634e8, 0.1634e8, 0.1634e8);
const double DWL2015_ReissnerTire::m_rho_2 = 0.11e4;
const ChVector<> DWL2015_ReissnerTire::m_E_2(0.474e8, 0.474e8, 0.474e8);
const double DWL2015_ReissnerTire::m_nu_2 = 0.45;
const ChVector<> DWL2015_ReissnerTire::m_G_2(0.1634e8, 0.1634e8, 0.1634e8);

const unsigned int DWL2015_ReissnerTire::m_num_elements_bead = 2;
const unsigned int DWL2015_ReissnerTire::m_num_layers_bead = 3;
const std::vector<double> DWL2015_ReissnerTire::m_layer_thickness_bead{{0.5e-03, 0.5e-02, 0.5e-03}};
const std::vector<double> DWL2015_ReissnerTire::m_ply_angle_bead{{90, 0, 90}};
const std::vector<int> DWL2015_ReissnerTire::m_material_id_bead{{0, 2, 0}};

const unsigned int DWL2015_ReissnerTire::m_num_elements_sidewall = 4;
const unsigned int DWL2015_ReissnerTire::m_num_layers_sidewall = 3;
const std::vector<double> DWL2015_ReissnerTire::m_layer_thickness_sidewall{{0.5e-03, 0.1e-03, 0.5e-03}};
const std::vector<double> DWL2015_ReissnerTire::m_ply_angle_sidewall{{90, 0, 90}};
const std::vector<int> DWL2015_ReissnerTire::m_material_id_sidewall{{0, 2, 0}};

const unsigned int DWL2015_ReissnerTire::m_num_elements_tread = 6;
const unsigned int DWL2015_ReissnerTire::m_num_layers_tread = 4;
const std::vector<double> DWL2015_ReissnerTire::m_layer_thickness_tread{{0.1e-02, 0.3e-03, 0.3e-03, 0.5e-03}};
const std::vector<double> DWL2015_ReissnerTire::m_ply_angle_tread{{0, -20, 20, 90}};
const std::vector<int> DWL2015_ReissnerTire::m_material_id_tread{{2, 1, 1, 0}};

const int DWL2015_ReissnerTire::m_div_circumference = 90;

const float DWL2015_ReissnerTire::m_friction = 0.9f;
const float DWL2015_ReissnerTire::m_restiturion = 0.1f;
const float DWL2015_ReissnerTire::m_Young = 2.0e6f;
const float DWL2015_ReissnerTire::m_Poisson = 0.3f;
const float DWL2015_ReissnerTire::m_kn = 2.0e6f;
const float DWL2015_ReissnerTire::m_gn = 1.3e1f;
const float DWL2015_ReissnerTire::m_kt = 1.0e6f;
const float DWL2015_ReissnerTire::m_gt = 0;

const unsigned int DWL2015_ReissnerTire::m_num_points = 71;
const double DWL2015_ReissnerTire::m_profile[71][3] = {
...
DWL2015_ReissnerTire::DWL2015_ReissnerTire(const std::string& name) : ChReissnerTire(name) {
...
void DWL2015_ReissnerTire::CreateMesh(const ChFrameMoving<>& wheel_frame, VehicleSide side) {
...
std::vector<std::shared_ptr<fea::ChNodeFEAbase>> DWL2015_ReissnerTire::GetConnectedNodes() const {
