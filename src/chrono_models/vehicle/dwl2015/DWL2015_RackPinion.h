...
#ifndef DWL2015_RACKPINION_H
#define DWL2015_RACKPINION_H
...
class CH_MODELS_API DWL2015_RackPinion : public ChRackPinion {
  public:
    DWL2015_RackPinion(const std::string& name);
    ~DWL2015_RackPinion() {}
